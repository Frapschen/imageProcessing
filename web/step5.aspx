<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="step5.aspx.cs" Inherits="web.step5" %>
    ...
    <form id="form1" runat="server">
        <table class="auto-style1" border="1">
            ...
            <tr>
                ...
                &nbsp;<br />
&nbsp;<asp:Button ID="Button1" runat="server" Text="连通域及其质心标记" OnClick="Button1_Click" />
