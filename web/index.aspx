...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1" border="1">
            ...
            <tr>
                ...
                &nbsp;
                    <asp:Button ID="Button1" runat="server" Text="灰度化" OnClick="Button1_Click" />
    ...
    <p> 
        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/step2.aspx">下一步：二值化</asp:LinkButton>
        只支持JPG格式的图片</p>
    </form>
